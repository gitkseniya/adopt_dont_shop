...
RSpec.describe 'the pets index' do
  ...
  it 'only lists adoptable pets' do
    ...
    pet_1 = Pet.create(adoptable: true, age: 1, breed: 'sphynx', name: 'Lucille Bald', shelter_id: shelter.id)
    pet2 = Pet.create(adoptable: true, age: 3, breed: 'doberman', name: 'Lobster', shelter_id: shelter.id)
    pet3 = Pet.create(adoptable: false, age: 2, breed: 'saint bernard', name: 'Beethoven', shelter_id: shelter.id)
  ...
  it 'displays a link to edit each pet' do
    ...
    expect(page).to have_content("Edit #{pet2.name}")
  ...
  it 'displays a link to delete each pet' do
    ...
    expect(page).to have_content("Delete #{pet2.name}")
  ...
  it 'lists partial matches as search results' do
    ...
    pet2 = Pet.create(adoptable: true, age: 3, breed: 'domestic pig', name: 'Babe', shelter_id: shelter.id)
    pet3 = Pet.create(adoptable: true, age: 4, breed: 'chihuahua', name: 'Elle', shelter_id: shelter.id)
