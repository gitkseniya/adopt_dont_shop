...
RSpec.describe VeterinaryOffice, type: :model do
  ...
  before(:each) do
    @vet_office1 = VeterinaryOffice.create(name: 'Best Vets', boarding_services: true, max_patient_capacity: 20)
    @vet_office2 = VeterinaryOffice.create(name: 'Vets R Us', boarding_services: true, max_patient_capacity: 20)
    ...
    @vet1 = Veterinarian.create(name: 'Taylor', review_rating: 10, on_call: true,
                                 veterinary_office_id: @vet_office1.id)
    @vet2 = Veterinarian.create(name: 'Jim', review_rating: 8, on_call: true, veterinary_office_id: @vet_office1.id)
    @vet3 = Veterinarian.create(name: 'Sarah', review_rating: 9, on_call: true, veterinary_office_id: @vet_office2.id)
  end
